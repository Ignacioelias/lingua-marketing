...
function LoveLetters() {
  ...
  const quotes = [
    { who: t('love.who1'), role: t('love.role1'), img: '../../assets/persona-tara.avif',    q: t('love.q1') },
    { who: t('love.who2'), role: t('love.role2'), img: '../../assets/persona-rahul.avif',    q: t('love.q2') },
    { who: t('love.who3'), role: t('love.role3'), img: '../../assets/persona-suzanne.avif',  q: t('love.q3') },
  ];
  return (
