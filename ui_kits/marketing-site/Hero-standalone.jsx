...
const PERSONA_PHOTOS = [
  window.__resources.persona0,  // 0  novelist
  window.__resources.persona1,    // 1  knowledge worker
  window.__resources.persona2,    // 2  researcher
  window.__resources.persona3,  // 3  founder
  window.__resources.persona4,  // 4  account manager
  window.__resources.persona5,    // 5  doctor
  window.__resources.persona6,  // 6  teacher
  window.__resources.persona7,    // 7  operator
  window.__resources.persona8,  // 8  bilingual writer
  window.__resources.persona9,    // 9  photographer
  window.__resources.persona10,  // 10 meetings PM
  window.__resources.persona11,    // 11 journalist
  window.__resources.persona12,    // 12 engineering lead
  window.__resources.persona13,  // 13 designer
  window.__resources.persona14,     // 14 startup PM
  window.__resources.persona15,  // 15 older professional
  window.__resources.persona16,  // 16 wellbeing
  window.__resources.persona17,    // 17 solo founder
  window.__resources.persona18,    // 18 consultant
  window.__resources.persona19,   // 19 screenwriter
];
  ...
  return (
    <section className="lg-hero" id="home">
      ...
      <div className="lg-hero__platforms">
        <span><img src={window.__resources.iconApple} width="14" height="14" alt="" /> {t('hero.platform.mac')}</span>
        <span><img src={window.__resources.iconWindows} width="14" height="14" alt="" /> {t('hero.platform.windows')}</span>
      </div>
      <div className="lg-hero__ctas">
        ...
        ><img src={window.__resources.wisprIconMic} width="14" height="14" alt="" /> {t('hero.cta.try')}</a>
      </div>
